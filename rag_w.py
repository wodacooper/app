...
class PDFRagSystem:
    ...
    def get_suggested_questions(self) -> List[str]:
        ...
        return [
            ...
            "What is the \"address/location\" of the property being sold?",
            "What is the \"initial earnest deposit\" amount? and non-refundable amounts/dates?",
    ...
    def ask_suggested_questions_per_document(self, output="to_excel.xlsx"):
        ...
        for doc in documents:
            ...
            for q in questions:
                ...
                st.markdown("---")
                print(f"✅ {answer}\n")
                if(q == "What is the \"purchase price\" of the property?"):
                    numbers = self._extract_numbers(answer)
                    row[matches[0]] = ", ".join(numbers) if numbers else ""
                else:
                    row[matches[0]] = answer
    ...
    def _extract_numbers(self, text: str):
        pattern = r'\$?\d[\d,]*\.?\d*%?|\d{1,2}/\d{1,2}/\d{2,4}'
